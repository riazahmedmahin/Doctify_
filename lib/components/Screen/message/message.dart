      ...
      child: SafeArea(
        child: Column(
          children: [
            Row(
              children: [
                const Icon(Icons.mic, color:  Color.fromARGB(255, 22, 108, 207),),
                      ...
                      Expanded(
                        child: TextField(
                          decoration: InputDecoration(
                                  ...
                                  InkWell(
                                    ...
                                    child: Icon(
                                      ...
                                      color: _showAttachment
                                          ? const  Color.fromARGB(255, 22, 108, 207)
                                          : Theme.of(context)
                                              .textTheme
                                              .bodyLarge!
                                              .color!
                            ...
                            filled: true,
                            fillColor:
                                const  Color.fromARGB(255, 22, 108, 207).withOpacity(0.08),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color: const  Color.fromARGB(255, 22, 108, 207).withOpacity(message!.isSender ? 1 : 0.1),
      ),
      child: Row(
        children: [
          Icon(
            Icons.play_arrow,
            color: message!.isSender ? Colors.white : const  Color.fromARGB(255, 22, 108, 207),
          ),
          Expanded(
            child: Padding(
    ...
    Color dotColor(MessageStatus status) {
      switch (status) {
        ...
        case MessageStatus.viewed:
          return const Color.fromARGB(255, 95, 85, 144);
        default:
